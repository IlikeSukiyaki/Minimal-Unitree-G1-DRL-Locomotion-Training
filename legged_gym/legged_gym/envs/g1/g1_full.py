...
class G1(LeggedRobot):
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        if self.cfg.terrain.measure_heights:
            heights_start_idx = 9+3*self.num_actions+2
            heights_end_idx = heights_start_idx + len(self.cfg.terrain.measured_points_x) * len(self.cfg.terrain.measured_points_y)
            noise_vec[heights_start_idx:heights_end_idx] = 0.1 * noise_level  # Add small noise to height measurements
