...
class TaskRegistry():
    ...
    def make_alg_runner(self, env, name=None, args=None, train_cfg=None, log_root="default") -> Tuple[OnPolicyRunner, LeggedRobotCfgPPO]:
        ...
        if train_cfg.runner.resume:
            ...
            model_root = os.path.join(LEGGED_GYM_ROOT_DIR, 'logs', train_cfg.runner.experiment_name)
            resume_path = get_load_path(model_root, load_run=train_cfg.runner.load_run, checkpoint=train_cfg.runner.checkpoint)
            print(f"Loading model from: {resume_path}")
            # First move model to CPU before loading
            runner.alg.actor_critic.to('cpu')
            ...
            runner.alg.actor_critic.to(args.sim_device)
